...
import { state, navmenuItems } from "../model.js";
...
class HeaderView extends App {
    ...
    constructor() {
        ...
        this.element = document.querySelector("header") as Element;
        
        this.navmenu = this.element.querySelector(".header__navmenu") as Element;
    ...
    eventHandler() {
        this.navmenu.querySelectorAll(".header__navmenuItem")?.forEach((el: Element) => {
        ...
        this.navmenu.querySelectorAll(".header__navmenuItemOptionsItem")?.forEach((el: Element) => {
    ...
    updateNavmenu() {
        ...
        const markup = /*html*/`
        ${
            state.navmenuItems.map((item: navmenuItems) => {
                return (/*html*/`
                <li class="header__navmenuItem ${item?.name}" id="navmenuItem${item?.id}">
                  ...
                  ${item?.options ? /*html*/`
                    <ul class="header__navmenuItemOptions dropdown${item?.id}">
                        ${
                        item?.options.map((innerItem: navmenuItems) => {
                            return (/*html*/`
                              ...
                              ${
                                innerItem?.options?.map((innerInnerItem: navmenuItems) => {
                                    return (/*html*/`
